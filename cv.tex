...
\cventry{2017}{Desenvolvedor Backend}{Wololo}{Recife}{}{
	...
	\begin{itemize}
		\item Desenvolvi uma API JSON rápida e leve
%
		\item Escrevi documentação detalhada para desenvolvedores
			frontend
%
		\item Configurei servidores para serem rápidos e estáveis a
			baixo custo
	\end{itemize}
}
