...
%
%	Desenvolvimento do site da \emph{APROSMIG -- Associação das Prostitutas
%	de Minas Gerais} --, em Jekyll, hospedado pelo \emph{Github Pages}.
%
%	{\scriptsize\url{http://aprosmig.org.br}}
%
\item[2017--Presente] Introdução da \emph{RaspberryPI} à comunidade do \emph{Igapó-Açu}

	Elaboração de material didático introdutório à computação e ao hardware
	da \emph{RaspberryPI} voltado para a comunidade ribeirinha do
	\emph{Igapó-Açu}, Amazonas, Brasil.

\item[2006--Presente] Motor de jogos 3D

	Desenvolvimento de motor de jogos 3D que utiliza uma árvore \emph{BSP}
	para acelerar gráficos e testes de colisão. Inspirada em \emph{Quake},
	escrita do zero em C, com \emph{libSDL} e \emph{OpenGL}.
