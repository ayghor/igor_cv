...
%
	{\scriptsize Backend em \textbf{Ruby} com \textbf{Roda},
	\textbf{Sequel} e \textbf{PostgreSQL}.}
%
	\begin{itemize}
...
%
	{\scriptsize Blog em \textbf{Ruby on Rails} com \textbf{PostgreSQL},
	\textbf{Elasticsearch} e \textbf{Sidekiq}.}
%
	\begin{itemize}
...
%
		\item Implementei SSL, melhorando a colocação em motores de
			busca
%
		\item Implementei API JSON e notificações push, permitindo a
...
%
	{\scriptsize Serviço web em \textbf{Ruby on Rails} e cliente de
	impressão em \textbf{Java}.}
%
	\begin{itemize}
...
\cventry{2011--2013}{Desenvolvedor Júnior}{Bebop}{Brasília}{}{
	...
	e entretenimento.\\
%
	{\scriptsize Produtos diversos utilizando \textbf{C}, \textbf{Java},
...
\section{Projetos}
\cventry{2017--Agora}{Introdução da Raspberry~PI à comunidade do Igapó-Açu}{}{}{}{
	Pequeno curso sobre computação e seus impactos na sociedade voltada aos
	jovens da comunidade ribeirinha do Igapó-Açu, Amazonas, Brasil.\\
%
	{\scriptsize Texto em \textbf{\LaTeX{}}, práticas com a
%
	\textbf{Raspberry~PI}.}
}

\cventry{2006--Agora}{Teh Engine -- Motor de jogos 3D}{}{}{}{
	Motor de jogos 3D que utiliza àrvores BSP para acelerar gráficos e
	detecção de colisões.\\
%
	{\scriptsize Escrita do zero em \textbf{C} com \textbf{libSDL} e
	\textbf{OpenGL}.}\\
%
...
\cventry{2006--2011}{Rogix -- Distribuição Linux}{}{}{}{
	Distribuição Linux feita do zero.\\
%
	{\scriptsize Ferramentas e automações em \textbf{shell script}.}\\
%
