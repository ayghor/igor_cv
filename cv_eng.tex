...
\item[2017--Now] Introduction of the \emph{Raspberry PI} to the \emph{Igapó-Açu} community

	I'm writing an introduction to computing and the \emph{Raspberry PI}
	hardware aimed at the youth of the \emph{Igapó-Açu} riverside
	community, Amazonas, Brasil.
